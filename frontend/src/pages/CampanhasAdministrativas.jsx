...
function CampanhasAdministrativas(){
  ...
  return <main className="pagina-administrativa"><div className="conteudo-administrativo campanhas-pagina">
    ...
    {administrador&&<details className="cartao secao-secundaria-campanha gerenciar-templates-campanha"><summary>Gerenciar modelos de mensagem</summary><div className="conteudo-templates-campanha">
      ...
      <p className="aviso-estado-campanha">{templateOficialEdicao?(template.statusOficial==='APPROVED'?'O conteúdo aprovado não é alterado aqui. Estas informações servem somente para preparar o envio.':'A Meta é a fonte do status oficial. Aguarde a análise ou atualize a lista antes de configurar o envio.'):'Salvar cria somente um rascunho. Enviar para análise faz a Meta avaliar o modelo e não envia mensagens para contatos.'}</p>
      ...
      </div></form><PreviaModeloMensagem template={template}/></div>
