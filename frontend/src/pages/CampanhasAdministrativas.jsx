...
function CampanhasAdministrativas(){
  ...
  async function salvarTemplate(evento){
    ...
    try{
      ...
      await carregar();
    }catch(erro){setMensagem(templateOficialEdicao?'Não foi possível salvar a configuração da imagem. '+erro.message:erro.message);}finally{setSalvandoTemplate(false);}
  }
